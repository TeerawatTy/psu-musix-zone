      ...
      <h1 className="ml-4">
        <Link href="/">
          <img
            ...
            alt="Home"
            className="h-10 transition-transform duration-200 ease-in-out hover:scale-125" // Increased scale on hover
          />
        </Link>
      </h1>
      ...
      <h1 className="text-xl mr-4">
        <Link href="/login" className="flex items-center">
          ...
          <svg
            ...
            height="35"
            viewBox="0 0 48 48"
            className="transition-transform duration-200 ease-in-out hover:scale-125" // Increased scale on hover
          >
            <path
